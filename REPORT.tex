...
del hackathon); Cyanite (BPM/tono/mood) \textbf{integrada}, a la espera del token.}
...
\begin{itemize}
  \item \textbf{Cyanite:} en cuanto llegue el token, BPM/tono/mood oficiales (\code{cyanite.py} ya
        implementa el flujo \emph{fileUploadRequest} $\to$ \emph{libraryTrackCreate} $\to$ análisis V7).
